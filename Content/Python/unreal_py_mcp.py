...
def _build_startup_guidance():
    ...
    return {
        ...
        "recommended_system_prompt_snippet": (
            f"Available MCP Server: UnrealPyMCP / unreal_py_mcp ({server_url}). "
            "Tools: unreal_py_mcp/get_logs, unreal_py_mcp/get_log_path, unreal_py_mcp/exec, unreal_py_mcp/exec_async. "
...
def _tool_definitions_with_runtime_context():
    ...
    for name, tool_data in MCP_TOOLS.items():
        ...
        if name == "unreal_py_mcp/get_logs" and resolved:
    ...
    return {
        ...
        "examples": [
            ...
            },
            {
                ...
                "request": {
                    "tool": "unreal_py_mcp/get_log_path",
                    "arguments": {},
                },
            },
        ],
